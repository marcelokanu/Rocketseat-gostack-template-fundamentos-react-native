<img src="src/assets/logo@3x.png" alt="gomarketplace" width="100%">
...
6. Executar via terminal o comando `react-native run-android` (utilizando Android Studio Emulator no Windows)
